...
<input type="submit" value="Iniciar Sesion" class="bg-sky-600 hover:bg-sky-700 transition-colors curson-pointer uppercase font-bold w-full p-3 text-white rounded-lg"  />
